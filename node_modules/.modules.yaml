...
hoistedDependencies:
  ...
  create-jest@29.7.0(@types/node@22.2.0):
    create-jest: private
  cross-spawn@7.0.3:
    cross-spawn: private
  debug@4.3.6:
  ...
  jest-circus@29.7.0:
    jest-circus: private
  jest-cli@29.7.0(@types/node@22.2.0):
    jest-cli: private
...
pendingBuilds: []
prunedAt: Mon, 12 Aug 2024 08:03:16 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@biomejs/cli-win32-x64@1.8.3'
  - fsevents@2.3.3
storeDir: /home/mokalbari/.local/share/pnpm/store/v3
